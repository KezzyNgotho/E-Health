        ...
        <Portal>
          <Modal visible={isLocationModalVisible} onDismiss={() => setIsLocationModalVisible(false)} contentContainerStyle={styles.locationModal}>
            <View style={styles.modalContent}>
              ...
              />
              <Button mode="contained" onPress={() => setIsLocationModalVisible(false)} style={styles.button}>Close</Button>
            </View>
          </Modal>
        </Portal>
...
const styles = StyleSheet.create({
  ...
  pharmacyItem: { padding: 10, backgroundColor: '#f8f8f8', marginVertical: 5, borderRadius: 4 },
  productItem: { padding: 10, borderBottomWidth: 1, borderBottomColor: '#ddd' },
  locationModal: { backgroundColor: 'white', padding: 20, borderRadius: 8 },
