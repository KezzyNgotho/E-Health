...
const App = ({ navigation }) => {
  ...
  const fetchNearbyPharmacies = async (location) => {
    try {
      // Query Firestore for pharmacies with the same location
      ...
      if (!querySnapshot.empty) {
        querySnapshot.forEach(doc => {
          ...
          console.log("Pharmacy found: ", pharmacyData);
          // Handle the pharmacy data (e.g., display it on the UI)
        });
      } else {
