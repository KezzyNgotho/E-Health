...
import firestore from '@react-native-firebase/firestore'; // Corrected import for Firestore
import auth from '@react-native-firebase/auth'; // Corrected import for Firebase Auth
