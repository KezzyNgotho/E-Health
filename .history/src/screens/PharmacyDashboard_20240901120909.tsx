        ...
        <ScrollView style={styles.scrollContent}>
          ...
          <Card containerStyle={styles.card}>
            ...
            <View style={styles.bestSellingItems}>
              <Text style={styles.itemText}>240 Items - Panadol</Text>
              <Text style={styles.itemText}>88 Items - ARVS</Text>
              <Text style={styles.itemText}>31 Items - Mara Moja</Text>
            </View>
          </Card>
          ...
          <Card containerStyle={styles.card}>
            ...
            <View style={styles.item}>
              <Text style={styles.itemName}>Paracetamol</Text>
              <Text style={styles.itemPrice}>$66.75</Text>
              <Text style={styles.itemWeight}>250 g</Text>
            </View>
            <View style={styles.item}>
              <Text style={styles.itemName}>Panadol</Text>
