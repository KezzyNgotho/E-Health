...
const App = ({ navigation }) => {
  ...
  const pharmacies = [
    { id: '1', name: 'Pharmacy 1', image: require('../assets/pexels-karolina-grabowska-5650026.jpg') },
    { id: '2', name: 'Pharmacy 2', image: require('../assets/pexels-tanya-nova-2593907-4371873.jpg') },
  ];
